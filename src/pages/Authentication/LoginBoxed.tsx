...
import  {submitForm}  from '../../functionList/Global';

    const LoginBoxed = () => {
    const dispatch = useDispatch();
    // useNavigate is used for navigation
    const navigate = useNavigate();
    // useEffect is used for after page render what function we need to fire
    useEffect(() => {
    // dispatch is used for store values in redux store
    ...
    const [formData, setFormData] = useState({
      ...
      const handleChange = (e) => {
        // Update the state by spreading the existing state and only modifying the target property
        setFormData({
          ...formData,
    ...
    const handleFormSubmit = () => {
        // submitForm is a global function for all api
        submitForm(username, password, navigate,dispatch);
      };
                ...
                <div className="relative w-full max-w-[870px] rounded-md bg-[linear-gradient(45deg,#fff9f9_0%,rgba(255,255,255,0)_25%,rgba(255,255,255,0)_75%,_#fff9f9_100%)] p-2 dark:bg-[linear-gradient(52.22deg,#0E1726_0%,rgba(14,23,38,0)_18.66%,rgba(14,23,38,0)_51.04%,rgba(14,23,38,0)_80.07%,#0E1726_100%)]">
                    <div className="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[758px] py-20">
                        ...
                        <div className="mx-auto w-full max-w-[440px]">
                            <div className="mb-10">
                                <h1 className="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">Cloud BATS</h1>
                            ...
                            <div className="space-y-5 dark:text-white" >
                                <div>
                                    ...
                                    <div className="relative text-white-dark">
                                        <input id="Email" type="email" placeholder="Enter Email" className="form-input ps-10 placeholder:text-white-dark" name="username" value={username} onChange={handleChange} />
                                ...
                                <div>
                                    ...
                                    <div className="relative text-white-dark">
                                        <input id="Password" type="password" placeholder="Enter Password" className="form-input ps-10 placeholder:text-white-dark" name='password' value={password} onChange={handleChange} />
                                        <span className="absolute start-4 top-1/2 -translate-y-1/2">
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                <path
                                                    opacity="0.5"
                                ...
                                <button onClick={handleFormSubmit} className="btn btn-gradient !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]">
                                    Sign in
                                </button>
                            </div>
